...
public class RasterDocument
{
    ...
    private String TopMarginCommand(RasTopMargin source)
    {
        ...
        switch(source)
        {
            case Default: return cmd + "0\0";
            case Small: return cmd + "1\0";
            case Standard: return cmd + "2\0";
        }
    ...
    private String SpeedCommand(RasSpeed source)
    {
        ...
        switch (source)
        {
            case Full: return cmd + "0\0";
            case Medium: return cmd + "1\0";
            case Low: return cmd + "2\0";
        }
    ...
    private String EndPageModeCommandValue(RasPageEndMode mode)
    {
        switch (mode)
        {
            ...
            case None: return "1";
            case FeedToCutter: return "2";
            case FeedToTearbar: return "3";
            case FullCut: return "8";
            case FeedAndFullCut: return "9";
            case PartialCut: return "12";
            case FeedAndPartialCut: return "13";
            case Eject: return "36";
            case FeedAndEject: return "37";
            default:
                return "0";
        }
    }
