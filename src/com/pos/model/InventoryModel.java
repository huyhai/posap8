...
public class InventoryModel {
	...
	public final static String[] VATTU_FULL_PROJECTION = { InventoryModel.ID,
			InventoryModel.GROUPID, InventoryModel.CODE, InventoryModel.IMAGE,
			InventoryModel.BARCODE, InventoryModel.UOM, InventoryModel.COSTPRICE,
			InventoryModel.PRICE1, InventoryModel.PRICE2, InventoryModel.SPECALPRICE,
			InventoryModel.STATUS, InventoryModel.REMARKS, InventoryModel.NAME };
