...
public class ItemsModel {
	...
	public final static String[] VATTU_FULL_PROJECTION = { ItemsModel.ID,
			ItemsModel.GROUPID, ItemsModel.CODE, ItemsModel.IMAGE,
			ItemsModel.BARCODE, ItemsModel.UOM, ItemsModel.COSTPRICE,
			ItemsModel.PRICE1, ItemsModel.PRICE2, ItemsModel.SPECALPRICE,
			ItemsModel.STATUS, ItemsModel.REMARKS, ItemsModel.NAME };
